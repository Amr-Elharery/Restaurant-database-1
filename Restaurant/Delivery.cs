        ...
        private void btnOrder_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string reserveTableQuery = "INSERT INTO delivary (staff_id, order_id, customer_number, date_deli) " +
                                               "VALUES (1, @orderId, @number, @date)";
                    using (SqlCommand command = new SqlCommand(reserveTableQuery, conn))
                    {
                        ...
                        MessageBox.Show("Delivery reserved successfully!\nPlease wait from 30min to 45min");
                    }
                ...
                {
                    MessageBox.Show("An error occurred while order delivery: " + ex.Message);
                }
